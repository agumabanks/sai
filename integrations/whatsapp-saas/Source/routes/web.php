...
// Soko SSO auto-login (outside auth middleware — consumes one-time token)
Route::get('/soko-sso/{token}', [\App\Http\Controllers\Api\SokoSsoController::class, 'loginWithToken'])
    ->middleware('web')
    ->name('soko.sso.login');
